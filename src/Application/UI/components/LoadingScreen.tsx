        ...
        >
                ...
                >
                    ...
                    >
                        ...
                        <div style={styles.headerInfo}>
                            <p>Released: 01/13/2022</p>
                            <p>DUK_BIOS (C)2022 Fernando Duck Inc.,</p>
                        </div>
                    </div>
                    <div style={styles.body} className="loading-screen-body">
                        <p>DUK N13 2022-2025 Unit QAK131103S</p>
                        <div style={styles.spacer} />
                        {showBiosInfo && (
                            <>
                                <p>DUK Showcase(tm) XX 11303</p>
                        ...
                        {showLoadingResources && doneLoading && (
                            <p>
                                ...
                                <b style={styles.green}>
                                    'PRINT_ Portifolio de Fernando Bezerra ~
                                    _DUCK_OS_ F1ABC2B_Ox'
                                </b>{' '}
                                V1.3
                            </p>
                        )}
            ...
            >
                <div style={styles.startPopup}>
                    ...
                    <div style={styles.spacer} />
                    <div style={styles.spacer} /> */}
                    <p>Portifolio de Fernando Bezerra ~ _DUCK_OS_</p>
                    {mobileWarning && (
                        <>
                            <br />
                            <b>
                                <p style={styles.warning}>
                                    AVISO: Melhor aproveitado em um ambiente
                                </p>
                                <p style={styles.warning}>
                                    desktop ou notebook.
                                </p>
